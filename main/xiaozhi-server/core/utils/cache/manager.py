...
class GlobalCacheManager:
    ...
    def delete(self, cache_type: CacheType, key: str, namespace: str = "") -> bool:  # TODO: dead code — remove (0 callers)
        """删除缓存条目"""
        cache_name = self._get_cache_name(cache_type, namespace)
    ...
    def clear(self, cache_type: CacheType, namespace: str = "") -> None:  # TODO: dead code — remove (0 callers)
        """清空指定缓存"""
        cache_name = self._get_cache_name(cache_type, namespace)
    ...
    def invalidate_pattern(  # TODO: dead code — remove (0 callers)
