...
class Dialogue:
    ...
    def remove_temporary(self) -> int:
        before = len(self.dialogue)
        self.dialogue = [m for m in self.dialogue if not m.is_temporary]
        return before - len(self.dialogue)
    ...
    def get_llm_dialogue_with_memory(
            ...
            emotion_desc: str = None, thinking_result: dict = None
    ) -> List[Dict[str, str]]:
        dialogue = []
