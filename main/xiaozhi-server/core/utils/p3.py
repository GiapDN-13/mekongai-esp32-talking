...
def decode_opus_from_file(input_file):  # TODO: dead code — remove (callers use decode_opus_from_file_stream instead)
    """
...
def decode_opus_from_bytes(input_bytes):  # TODO: dead code — remove (callers use decode_opus_from_bytes_stream instead)
    """
