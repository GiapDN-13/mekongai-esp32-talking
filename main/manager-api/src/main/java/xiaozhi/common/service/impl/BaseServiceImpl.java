...
/**
 * Base {@link BaseService} implementation wrapping {@link BaseMapper}.
...
public abstract class BaseServiceImpl<M extends BaseMapper<T>, T> implements BaseService<T> {
    ...
    /**
     * Build a MyBatis-Plus {@link Page} from request params.
     *
     * @param params            query map (see {@link Constant})
     * @param defaultOrderField fallback order column when none specified
     * @param isAsc             default order direction when using fallback
     * @see xiaozhi.common.constant.Constant
     *      params.put(Constant.PAGE, "1");
     *      params.put(Constant.LIMIT, "10");
     *      params.put(Constant.ORDER_FIELD, "field"); // single column
     *      params.put(Constant.ORDER_FIELD, List.of("field1", "field2")); // multiple columns
    ...
    protected IPage<T> getPage(Map<String, Object> params, String defaultOrderField, boolean isAsc) {
        ...
        // Page instance (also stored back into params)
    ...
    /**
     * Whether an update/delete/insert affected at least one row.
     * <p>
     * Must pass {@link Integer} (nullable), not primitive {@code int}.
     * </p>
     *
     * @param result row count from MyBatis
    ...
    /**
     * Run MyBatis batch session callback.
     */
