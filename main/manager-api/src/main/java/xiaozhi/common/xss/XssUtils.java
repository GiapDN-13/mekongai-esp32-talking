...
public class XssUtils extends Safelist {
    ...
    /**
     * Strip unsafe HTML using a fixed whitelist.
     */
    ...
    /**
     * Allowed tags / attributes / URL schemes for rich text.
     */
    private static Safelist xssWhitelist() {
        return new Safelist()
                ...
                // Allowed URL schemes for href/src/etc.
