...
public class VoiceResourceController {
    ...
    @GetMapping
    @Operation(summary = "Paginated voice resource list")
    @Parameters({
    ...
    @GetMapping("{id}")
    @Operation(summary = "Get voice resource detail")
    @RequiresPermissions("sys:role:superAdmin")
    ...
    @Operation(summary = "List voice resources by user ID")
    ...
    @Operation(summary = "List TTS platforms")
    @RequiresPermissions("sys:role:superAdmin")
