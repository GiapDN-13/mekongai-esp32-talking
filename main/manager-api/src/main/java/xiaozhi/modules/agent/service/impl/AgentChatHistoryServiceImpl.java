...
/**
 * {@link AgentChatHistoryService} implementation.
 *
 * @author Goody
...
public class AgentChatHistoryServiceImpl extends ServiceImpl<AiAgentChatHistoryDao, AgentChatHistoryEntity>
    ...
    public List<AgentChatHistoryUserVO> getRecentlyFiftyByAgentId(String agentId) {
        // No ORDER BY created_at: larger PK correlates with later time; avoids full sort on large tables.
    ...
    /**
     * If {@code content} is JSON with a {@code content} field, return that inner text; else return as-is.
     */
