...
public class AgentMcpAccessPointController {
    ...
    /**
     * MCP WebSocket URL for the agent (permission-checked).
     */
    @Operation(summary = "Get agent MCP access URL")
    ...
    @Operation(summary = "List MCP tools for an agent")
