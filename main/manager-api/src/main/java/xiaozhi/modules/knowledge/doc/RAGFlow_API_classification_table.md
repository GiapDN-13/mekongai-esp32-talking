...
## 1. External APIs (third-party integration)
**Path Prefix:** `/api/v1`
...
| **External** | `api/apps/sdk/doc.py` | `rm_chunk` | `/api/v1/datasets/<dataset_id>/documents/<document_id>/chunks` | Remove Chunk |


## 2. Internal APIs (web frontend)
