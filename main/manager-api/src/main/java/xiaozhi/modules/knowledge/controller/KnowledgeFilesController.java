...
public class KnowledgeFilesController {
    ...
    @Operation(summary = "Paged document list")
    ...
    @Operation(summary = "Paged document list filtered by parse status")
    @RequiresPermissions("sys:role:normal")
    ...
    @Operation(summary = "Delete one document")
    @RequiresPermissions("sys:role:normal")
    ...
    @PostMapping("/chunks")
    @Operation(summary = "Parse documents (chunk)")
    @RequiresPermissions("sys:role:normal")
    public Result<Void> parseDocuments(@PathVariable("dataset_id") String datasetId,
        ...
        if (documentIds == null || documentIds.isEmpty()) {
            return new Result<Void>().error("document_ids is required");
        }
        ...
        if (success) {
            ...
            return new Result<Void>().error("Parse failed; document may already be processing");
        }
    }
