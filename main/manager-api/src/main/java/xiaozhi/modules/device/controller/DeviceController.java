...
public class DeviceController {
    ...
    @Operation(summary = "Bind device with activation code")
    ...
    @Operation(summary = "Register device (get captcha code)")
    public Result<String> registerDevice(@RequestBody DeviceRegisterDTO deviceRegisterDTO) {
        ...
        // Generate a unique 6-digit captcha
        String code;
        String key;
    ...
    @Operation(summary = "List bound devices for agent")
    @RequiresPermissions("sys:role:normal")
    ...
    @Operation(summary = "Device online status (MQTT manager proxy)")
    @RequiresPermissions("sys:role:normal")
    ...
    @Operation(summary = "List device tools (MCP)")
    @RequiresPermissions("sys:role:normal")
    ...
    @Operation(summary = "Call device tool (MCP)")
    @RequiresPermissions("sys:role:normal")
