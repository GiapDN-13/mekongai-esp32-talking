...
public class SysDictDataController {
    ...
    @GetMapping("/page")
    @Operation(summary = "Paginated dictionary data")
    @RequiresPermissions("sys:role:superAdmin")
    @Parameters({ @Parameter(name = "dictTypeId", description = "Dictionary type id", required = true),
            @Parameter(name = "dictLabel", description = "Label"), @Parameter(name = "dictValue", description = "Value"),
    ...
    public Result<PageData<SysDictDataVO>> page(@Parameter(hidden = true) @RequestParam Map<String, Object> params) {
        ...
        // dictTypeId is required for this query
        if (!params.containsKey("dictTypeId") || StringUtils.isEmpty(String.valueOf(params.get("dictTypeId")))) {
            return new Result<PageData<SysDictDataVO>>().error("dictTypeId must not be empty");
        }
    ...
    @GetMapping("/{id}")
    @Operation(summary = "Get dictionary data by id")
    @RequiresPermissions("sys:role:superAdmin")
    ...
    @RequiresPermissions("sys:role:superAdmin")
    @Parameter(name = "ids", description = "Ids to delete", required = true)
    ...
    @Operation(summary = "List dictionary data by type code")
