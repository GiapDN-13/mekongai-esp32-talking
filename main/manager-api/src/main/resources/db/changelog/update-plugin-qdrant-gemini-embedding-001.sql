-- Canonical Gemini embedding id for google-generativeai embedContent: gemini-embedding-001 (not text-embedding-004).
...
-- Knowledge base preset row: keep id RAG_Qdrant_Gemini_004 for FK; set canonical embedding model
UPDATE ai_model_config
SET config_json = JSON_SET(CAST(config_json AS JSON), '$.embedding_model', 'gemini-embedding-001'),
    remark = 'Qdrant + Gemini gemini-embedding-001 (768-dim)'
