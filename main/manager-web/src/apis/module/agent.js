...
export default {
    ...
    // Get agent template paginated list
    getAgentTemplatesPage(params, callback) {
        RequestService.sendRequest()
            ...
            .networkFail((err) => {
                console.error('Failed to get template page list:', err);
                RequestService.reAjaxFun(() => {
    ...
    // Get recent user-type chat history for agent
    ...
    // Get chat history content by audio ID
    ...
    // Get single agent template by ID
