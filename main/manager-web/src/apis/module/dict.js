...
export default {
    ...
    getDictTypeDetail(id, callback) {
        RequestService.sendRequest()
            ...
            .networkFail((err) => {
                console.error('Failed to get dict type detail:', err)
                this.$message.error(err.msg || 'Failed to get dict type detail')
                RequestService.reAjaxFun(() => {
    ...
    getDictDataDetail(id, callback) {
        RequestService.sendRequest()
            ...
            .networkFail((err) => {
                console.error('Failed to get dict data detail:', err)
                this.$message.error(err.msg || 'Failed to get dict data detail')
                RequestService.reAjaxFun(() => {
