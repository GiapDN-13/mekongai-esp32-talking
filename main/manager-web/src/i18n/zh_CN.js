export default {
  ...
  'voicePrintDialog.voicePrintVector': '语音',
  ...
  'voicePrintDialog.fromHistory': '聊天记录',
  'voicePrintDialog.fromMicrophone': '录音',
  'voicePrintDialog.fromFile': '上传文件',
  'voicePrintDialog.noHistoryAudio': '暂无聊天记录。请录音或上传文件。',
  'voicePrintDialog.startRecording': '开始录音',
  'voicePrintDialog.stopRecording': '停止',
  'voicePrintDialog.recordingHint': '正在录音... 请清晰说话5-20秒',
  'voicePrintDialog.recordedDuration': '已录制',
  'voicePrintDialog.clickToUpload': '选择WAV/MP3文件（5-30秒）',
  ...
  // 注册页面相关
  'register.title': '创建账号',
  'register.welcome': '欢迎使用 MekongAI',
  ...
  'paramManagement.updateSuccess': '修改成功，部分配置需重启server模块才生效',
  ...
  'modelConfig.setDefaultSuccess': '设置默认模型成功，请及时手动重启server模块',
