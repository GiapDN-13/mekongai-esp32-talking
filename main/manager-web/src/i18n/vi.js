export default {
  ...
  'voicePrintDialog.voicePrintVector': 'Giọng nói',
  ...
  'voicePrintDialog.fromHistory': 'Lịch sử chat',
  'voicePrintDialog.fromMicrophone': 'Thu âm',
  'voicePrintDialog.fromFile': 'Tải file',
  'voicePrintDialog.noHistoryAudio': 'Chưa có lịch sử hội thoại. Hãy thu âm hoặc tải file.',
  'voicePrintDialog.startRecording': 'Bắt đầu thu âm',
  'voicePrintDialog.stopRecording': 'Dừng',
  'voicePrintDialog.recordingHint': 'Đang thu âm... Hãy nói rõ ràng 5-20 giây',
  'voicePrintDialog.recordedDuration': 'Đã thu',
  'voicePrintDialog.clickToUpload': 'Chọn file WAV/MP3 (5-30 giây)',
  ...
  'register.welcome': 'Chào mừng đến với MekongAI',
  ...
  'paramManagement.updateSuccess': 'Cập nhật thành công. Một số cấu hình chỉ có hiệu lực sau khi khởi động lại mô-đun server.',
  ...
  'modelConfig.setDefaultSuccess': 'Đặt mô hình mặc định thành công, vui lòng khởi động lại module server thủ công kịp thời',
